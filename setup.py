...
def get_version(*file_paths):
    """Retrieves the version from celery_persistent_revokes/__init__.py"""
...
version = get_version("celery_persistent_revokes", "__init__.py")
...
setup(
    ...
    url='https://github.com/hugobessa/celery-persistent-revokes',
    packages=[
